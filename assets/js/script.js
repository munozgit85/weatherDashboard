  ...
  //function to load recently searched cities from local storage
    ...
    function search() {
      ...
      function getUV(lat, lon) {
        ...
        $.ajax({
          url: "https://api.openweathermap.org/data/2.5/uvi?lat=" + lat + "&lon=" + lon + "&exclude=minutely,hourly"  + "&units=imperial&appid=42d98d76405f5b8038f2ad71187af430",
          method: "GET",
        }).then(function (response) {
          ...
          $("#high").text("Expected high (F): " + " " + cityHigh);
            ...
            let apiURL = "https://api.openweathermap.org/data/2.5/forecast?lat=" + lat + "&lon=" + lon + "&exclude=minutely,hourly"  + "&units=imperial&appid=42d98d76405f5b8038f2ad71187af430";
          ...
          $("#icon5").html(
            `<img src="http://openweathermap.org/img/wn"+ data.list[5].weather[0].icon + ".png">`
